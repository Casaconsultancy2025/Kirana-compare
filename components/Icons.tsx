...
export const AnalyzeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2.25a.75.75 0 01.75.75v2.51a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM12 18.75a.75.75 0 01.75.75v2.51a.75.75 0 01-1.5 0V19.5a.75.75 0 01.75-.75zM2.25 12a.75.75 0 01.75-.75h2.51a.75.75 0 010 1.5H3a.75.75 0 01-.75-.75zM18.75 12a.75.75 0 01.75-.75h2.51a.75.75 0 010 1.5H19.5a.75.75 0 01-.75-.75zM12 8.25a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM5.503 5.503a.75.75 0 010 1.06-5.25 5.25 0 007.424 7.424.75.75 0 11-1.06 1.06 6.75 6.75 0 01-9.546-9.546.75.75 0 011.06 0z" />
    </svg>
);
